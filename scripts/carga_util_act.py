...
def main():
    ...
    estado_modelo.pose.position.x = drone_state.pose.position.x
    estado_modelo.pose.position.y = drone_state.pose.position.y
    ...
    get_m_client = rospy.ServiceProxy("/gazebo/get_model_state", ModelState)

    # Esperamos por el servicio de gazebo para establecer el estado de los modelos
    rospy.wait_for_service("/gazebo/set_model_state")
    set_m_client = rospy.ServiceProxy("/gazebo/set_model_state")
